...
script_path=/personal/nipgt_code_review/pheno_classify/nice_5fold.py
data_path=/personal/nipgt_code_review/data_new/feature_extracted/decent_low80/
# save_path=/personal/nipgt_code_review/data_new/best_config_5fold/decent_low80/withPCA
save_path=/personal/nipgt_code_review/data_new/replicate
